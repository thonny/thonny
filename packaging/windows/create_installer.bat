...
@rem %BUILDDIR%\python -s -m pip install --no-warn-script-location --pre --no-cache-dir thonny==4.0.0b1
%BUILDDIR%\python -s -m pip install --no-warn-script-location ..\setuptools\thonny-4.0.0.dev0-py3-none-any.whl
