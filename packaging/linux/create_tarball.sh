...
# INSTALL DEPS ###################################
$TARGET_DIR/bin/python3.7 -m pip install jedi==0.12.*
$TARGET_DIR/bin/python3.7 -m pip install --no-cache-dir distro
$TARGET_DIR/bin/python3.7 -m pip install --no-cache-dir certifi

# INSTALL THONNY ###################################
$TARGET_DIR/bin/python3.7 -m pip install --no-cache-dir thonny
