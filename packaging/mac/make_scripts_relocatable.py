...
old_prelude1=b"#!/Library/Frameworks/Python.framework/Versions/3.14/bin/python3"
old_prelude2=b"#!" + script_dir.encode("ASCII") + b"/build/Thonny.app/Contents/Frameworks/Python.framework/Versions/3.14/bin/python3"

# https://stackoverflow.com/a/33225909/261181
new_prelude=b"""#!/bin/sh
"exec" "`dirname $0`/python3.14" "$0" "$@"
