...
3. Run install_tcltk.sh. This will download, compile and install latest suitable Tcl/Tk framework.
	(Tcl/Tk coming with Mac is too Old. NB! ActiveTcl doesn't have suitable license!)
...
4. Run create_dist_bundle.sh. This will pip-install newest Thonny into the Python copied into ~/thonny_template_build and create a distribution bundle under dist. This step needs to be done once after uploading new version of Thonny into PyPI.
