...
1. Install clean Python 3.9 into default Framework folder.
2. (If you want to bundle some 3rd party libraries, then pip-install these here)
3. Run create_base_bundle.sh. This will copy Python into ~/thonny_template_build_39
...
4. Run create_release.sh. This will pip-install newest Thonny into the Python 
	copied into ~/thonny_template_build_39 and create distribution packages under dist.
