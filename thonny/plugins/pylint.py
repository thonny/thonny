messages = [
 ...
 {'msg_id': 'E0601',
  ...
  'msg_xpln': "Used when a local variable is accessed before it's assignment.",
  'th_desc': '',
  'usage': 'skip'},
 {'msg_id': 'E0602',
 ...
 {'msg_id': 'W0104',
  ...
  'msg_xpln': "Used when a statement doesn't have (or at least seems to) any "
              'effect.',
  'th_desc': '',
  'usage': 'pylint'},
 {'msg_id': 'W0105',
 ...
 {'msg_id': 'W0603',
  ...
  'msg_xpln': 'Used when you use the "global" statement to update a global '
              'variable. Pylint just try to discourage this usage. That '
