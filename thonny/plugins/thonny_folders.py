...
def load_plugin() -> None:
    def cmd_open_data_dir():
        quit_data_dir = askyesno(
            ...
            message= tr("Do you want to close Thonny before enterring the data folder? This is useful if you want to manually edit the configuration files. Closing Thonny ensures that any changes you make are not overwritten and are properly loaded when Thonny restarts."),
