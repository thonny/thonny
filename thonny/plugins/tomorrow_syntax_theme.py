...
def tomorrow_night():
    ...
    return {
        ...
        # paren matcher
        "surrounding_parens"  : {"background" : "#373b41", "foreground" : "white",
                                 "font" : "BoldEditorFont"},
    }
...
def tomorrow_night_blue():
    ...
    return {
        ...
        # paren matcher
        "surrounding_parens"  : {"background" : "#00346e", "foreground" : "white",
                                 "font" : "BoldEditorFont"},
    }
...
def tomorrow_night_bright():
    ...
    return {
        ...
        # paren matcher
        "surrounding_parens"  : {"background" : "#2a2a2a", "foreground" : "white",
                                 "font" : "BoldEditorFont"},
    }
...
def tomorrow_night_eighties():
    ...
    return {
        ...
        # paren matcher
        "surrounding_parens"  : {"background" : "#393939", "foreground" : "white",
                                 "font" : "BoldEditorFont"},
    }
...
def load_plugin():
    ...
    get_workbench().add_syntax_theme("Tomorrow Night Bright", "Tomorrow Night", tomorrow_night_bright)
