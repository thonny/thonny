...
import audio  # this module is available via calliope since V2
...
class _MicroBitTouchPinBase:
    ...
    def set_touch_mode(self, mode:int) -> None:
        """
       . Use pin.CAPACITIVE (no need to touch GND with other hand)
...
class _MicroBitUART(object):
    ...
    def init(
        ...
        *,
        ...
        The parity parameter defines how parity is checked, and it can be None, calliope.uart.ODD or
        calliope.uart.EVEN. The stop parameter tells the number of stop bits, and has to be 1 for
        this board.
    ...
    def read(self, nbytes: Optional[int]=...) -> Optional[bytes]:
        ...
        via Python. The timeout, in milliseconds, is given by: calliope_uart_timeout_char = 13000 /
        baudrate + 1
...
class SoundEvent:
    """
    Enum for describing sound events..
    """
    LOUD: "SoundEvent" = ...
    QUIET: "SoundEvent" = ...
...
class _MicroBitMicrophone:
   ...
   .
    ...
    These sound events are represented by instances of the SoundEvent class, accessible via variables in calliope.SoundEvent:

    calliope.SoundEvent.QUIET: Represents the transition of sound events, from loud to quiet like speaking or background music.
    calliope.SoundEvent.LOUD: Represents the transition of sound events, from quiet to loud like clapping or shouting.
    """
