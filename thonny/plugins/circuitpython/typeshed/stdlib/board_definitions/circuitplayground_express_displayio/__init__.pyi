...
"""
Board stub for Adafruit CircuitPlayground Express with displayio
 - port: atmel-samd
 - board_id: circuitplayground_express_displayio
 - NVM size: 256
 - Included modules: analogio, array, audiobusio, audiocore, audioio, board, builtins, busdisplay, busio, busio.SPI, busio.UART, codeop, collections, digitalio, displayio, epaperdisplay, errno, fontio, fourwire, i2cdisplaybus, locale, math, microcontroller, neopixel_write, nvm, onewireio, os, pulseio, pwmio, rainbowio, random, storage, struct, supervisor, sys, terminalio, time, touchio, usb_cdc, usb_hid, warnings
 - Frozen libraries: adafruit_circuitplayground, adafruit_lis3dh, adafruit_thermistor, neopixel
"""
