...
Board stub for PewPew M4
 ...
 - board_id: pewpew_m4
 - NVM size: 256
 - Included modules: _stage, array, audiocore, audioio, audiomixer, board, builtins, busdisplay, busio, busio.SPI, busio.UART, collections, digitalio, displayio, epaperdisplay, fontio, fourwire, i2cdisplaybus, keypad, keypad.Keys, math, microcontroller, nvm, os, random, storage, struct, supervisor, sys, terminalio, time, usb_cdc, zlib
