...
Board stub for LoC BeR M4 base board
 ...
 - NVM size: 256
 - Included modules: alarm, analogio, array, board, builtins, busio, busio.SPI, busio.UART, collections, digitalio, math, microcontroller, neopixel_write, nvm, onewireio, os, ps2io, pwmio, rainbowio, random, rotaryio, rtc, samd, storage, struct, supervisor, sys, time, touchio, usb_cdc, usb_hid, usb_midi, watchdog
 - Frozen libraries: 
"""
