...
Board stub for Sprite_v2b
 ...
 - NVM size: 256
 - Included modules: _asyncio, adafruit_bus_device, alarm, analogio, array, atexit, binascii, bitbangio, board, builtins, builtins.pow3, busio, busio.SPI, busio.UART, codeop, collections, countio, digitalio, errno, frequencyio, i2ctarget, io, json, locale, math, microcontroller, neopixel_write, nvm, onewireio, os, os.getenv, pulseio, pwmio, random, re, rtc, samd, sdcardio, select, storage, struct, supervisor, sys, time, traceback, usb_cdc, watchdog, zlib
 - Frozen libraries: 
"""
