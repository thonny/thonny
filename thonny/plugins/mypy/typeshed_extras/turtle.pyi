...
class _Root(TK.Tk):
    ...
    def setupcanvas(
        self, width: Any, height: Any, cwidth: Any, cheight: Any
    ) -> None: ...
    def set_geometry(
        self, width: Any, height: Any, startx: Any, starty: Any
    ) -> None: ...
...
class Shape:
    ...
    def addcomponent(
        self, poly: Any, fill: Any, outline: Optional[Any] = None
    ) -> None: ...
...
class TurtleScreen(TurtleScreenBase):
    def __init__(
        self, cv: TK.Canvas, mode: Any, colormode: Any, delay: Any
    ) -> None: ...
    def clear(self) -> None: ...
    xscale = 0.0
    ...
    def listen(
        self, xdummy: Optional[Any] = None, ydummy: Optional[Any] = None
    ) -> None: ...
...
class RawTurtle(TPen, TNavigator):
    ...
    def write(
        self, arg: Any, move: bool = ..., align: str = ..., font: Any = None
    ) -> None: ...
    ...
    def onclick(self, fun: Any, btn: int = ..., add: Optional[Any] = None) -> None: ...
    def onrelease(
        self, fun: Any, btn: int = ..., add: Optional[Any] = None
    ) -> None: ...
