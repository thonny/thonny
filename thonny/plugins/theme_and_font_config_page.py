...
from thonny.shell import ShellText, BaseShellText
...
class ThemeAndFontConfigurationPage(ConfigurationPage):
    ...
    def _init_themes(self):
        ...
        ttk.Label(self, text="UI theme").grid(
    ...
    def _init_fonts(self):
        ...
        ttk.Label(self, text="IO font").grid(row=2, column=3, sticky="w", pady=(0, 5), padx=(25, 5))
    ...
    def _init_previews(self):
        ttk.Label(self, text="Preview").grid(
    ...
    def _insert_shell_text(self):
        ...
        text.direct_insert("end", "Enter an integer: ", ("io", "stdout"))
        text.direct_insert("end", "blah\n", ("io", "stdin"))
        text.direct_insert(
            "end", "ValueError: invalid literal for int() with base 10: 'blah'\n", ("io", "stderr")
        )
